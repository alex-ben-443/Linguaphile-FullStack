...
public class LPControl {
    ...
    @GetMapping("/getByCourse/{course}/{courserating}")
    public List<LPModel>getByCourse(@PathVariable String course,@PathVariable float courserating)
    {
    	return service.getByCourse(course, courserating);
    }
    //named parameter
    @GetMapping("/getByCourseRating/{courserating}")
    public List<LPModel>getByCourseRating(@PathVariable float courserating)
    {
    	return service.getByCourseRating(courserating);
    }
    //dml delete query
    @DeleteMapping("/deleteByCourse/{course}")
